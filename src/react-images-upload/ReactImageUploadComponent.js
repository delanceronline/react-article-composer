...
class ReactImageUploadComponent extends React.Component {
  ...
  removeImage(picture) {
    ...
    if(this.props.hasOwnProperty('onDelete') && typeof this.props.onDelete === 'function')
      this.props.onDelete(this.state.files, this.state.pictures, removeIndex);
    ...
    return (
      <div className={"fileUploader " + this.props.className} style={this.props.style}>
        <div className="fileContainer" style={this.props.fileContainerStyle}>
          {!this.props.isDisabled && (this.state.pictures.length == 0 || !this.props.singleImage) &&
            this.renderIcon()            
          }
          {!this.props.isDisabled && (this.state.pictures.length == 0 || !this.props.singleImage) &&
            this.renderLabel()
